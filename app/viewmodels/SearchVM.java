...
/**
 * View models that handle data for the search view
 */
public class SearchVM {
	private final List<String> cbns;
	
	public SearchVM(List<String> cbns){
		Objects.requireNonNull(cbns);
		
		this.cbns = cbns;
	}
	
	public List<String> getCbns(){
		return cbns;
	}
}
