...
import models.upload.UploadHistoryItem;

public class UploadVM {
private final List<UploadHistoryItem> history;
	
	public UploadVM(List<UploadHistoryItem> history){
		Objects.requireNonNull(history);
		
		this.history = history;
	}
	
	public List<UploadHistoryItem> getHistory(){
		return history;
	}
}
